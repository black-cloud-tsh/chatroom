<template>
  <div id="login-main">
    <div id="login-container">
      <span id="logo-name">Welcome</span>
...
export default {
  ...
  methods: {
    ...
    registerUser () {
      const _this = this
      const params = { username: this.registerForm.username, password: this.registerForm.password, phone: this.registerForm.phone }
      this.$axios.post('/register', null, { params: params })
        .then(function (res) {
          if (res.data.success) {
